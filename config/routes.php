...
$route['user/profile/update_password'] = 'user/profile_update_password';
$route['user/profile/update_image'] = 'user/profile_update_image';
$route['user/dashboard'] = 'user/dashboard';


$route['api/restserver/(:any)'] = 'api/restserver/$1';
$route['404_override'] = '';
